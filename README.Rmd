...
- **James**: the production server. This should always work, and is the default;
- **June**: the development server. New features will appear here first, but it is less stable;
- **Joshua**: the local server. Works only if the relevant images is running locally under Docker Desktop.
